...
if (isset($_POST['signup'])) {
    ...
    $sql = "INSERT INTO `students`(`student_id`, `fullname`, `email`, `mobile`, `password`, `status`, `reg_date`) VALUES  (:student_id, :fname, :email, :mobileno, :password, :status, :date_now)";
    ...
    $query->bindParam(':date_now', $date_now, PDO::PARAM_STR);
    $query->execute();
...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>E-Books System | Add User</title>
